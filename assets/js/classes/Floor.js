...
class Floor {
    ...
    setUpButtonState(pressed) {
        ...
        this.logger.debug(`Floor ${this.number} up button ${pressed ? 'pressed' : 'released'}`);
    }
    ...
    setDownButtonState(pressed) {
        ...
        this.logger.debug(`Floor ${this.number} down button ${pressed ? 'pressed' : 'released'}`);
    }
    ...
    setElevatorIndicator(elevatorId, direction) {
        ...
        this.logger.debug(`Floor ${this.number} elevator ${elevatorId} indicator set to ${direction || 'none'}`);
    }
    ...
    reset() {
        ...
        this.logger.debug(`Floor ${this.number} reset`);
    }
}